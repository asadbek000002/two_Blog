# Generated by Django 4.2.5 on 2023-09-29 08:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-create'],
                'indexes': [models.Index(fields=['-create'], name='actions_act_create_4b1545_idx'), models.Index(fields=['target_ct', 'target_id'], name='actions_act_target__5ecc2e_idx')],
            },
        ),
    ]
